    ...
    public void onMessage(Message message) {
        ...
        try {
            if (message instanceof ObjectMessage) {
                ...
                if (msg.getObject() instanceof UserEntity) {
                    UserEntity e = (UserEntity) msg.getObject();
                    save(e);
                } else if (msg.getObject() instanceof QuestionEntity) {
                    QuestionEntity e = (QuestionEntity) msg.getObject();
                    save(e);
                } else if (msg.getObject() instanceof UserQuestionEntity) {
                    UserQuestionEntity e = (UserQuestionEntity) msg.getObject();
                    save(e);
                }
            }
